...
344 23.07 локолизация проекта в настройки написал и и всё

Начинаем ускоренный темп!
python manage.py dumpdata shop --indent=2 - выводит все обьекты app

Мы можем наследовать модели в джанго, а именно 366. Делать абст рактные и прокси модели.(дополняет)

368 - обьектам модели можно присваивать динамичесике имена. Как пример мы используем наследование.
